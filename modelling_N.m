...
beta2=0.1832;
chi=0.0203;
gamma=[0.011 0.01 0.009 0.0085 0.0075 0]; 
n=5;
C0=15;
delta1=0.0762;
delta2=0.002;
...
legend('$\gamma$=0.011','$\gamma$=0.01','$\gamma$=0.009','$\gamma$=0.0085','$\gamma$=0.0075','$\gamma$=0','Interpreter','latex')
xlabel('Time')
ylabel('No. of people')
